...
export const TENANCY_STATE_SOURCES: VerifiedSourceRecord[] = [
  ...
  },
  {
    ...
    "domain": "TENANT_RIGHTS",
    "subdomain": "2F_STATE_SPECIFIC_LAW",
    "summary": "State tenancy legislation in Assam (enacted adopting the Model Tenancy Act framework): (1) Mandates execution of written tenancy agreement and joint submission of digital intimation to the Rent Authority; (2) Security deposit capped at a maximum of 2 months' rent for residential premises and 1 month's rent for non-residential premises; (3) Landlord cannot cut off or withhold essential services (water/electricity) under Section 20; (4) Landlord entry requires 24 hours prior written/electronic notice; (5) Mandatory rent receipts; (6) 3-tier dispute machinery: Rent Authority (Deputy Commissioner / SDO), Rent Court (Civil Judge), and Rent Tribunal (District Judge); (7) Eviction requires an order from the Rent Court; self-help evictions are strictly barred.",
    "jurisdiction": {
      "country": "IN",
      "state_ut": "Assam",
      "government_level": "STATE",
