...
export const BHARAT_LANGUAGES: Record<BharatLanguageCode, LanguageMetadata> = {
  ...
  "kn-IN": { code: "kn-IN", name: "Kannada", nativeName: "ಕನ್ನಡ", translationSupported: true, sttSupported: true, ttsSupported: true },
  "ml-IN": { code: "ml-IN", name: "Malayalam", nativeName: "മലയാളം", translationSupported: true, sttSupported: true, ttsSupported: true },
