    ...
    <div className="w-full space-y-16 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section className="space-y-6">
        <div className="text-center space-y-2">
          <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider block">{t("home.journeyBadge")}</span>
          <h2 className="text-2xl font-bold text-[#102A56]">{t("home.journeyTitle")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">{t("home.journey1Title")}</h3>
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">{t("home.journey2Title")}</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              {t("home.journey2Desc")}
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">{t("home.journey3Title")}</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              {t("home.journey3Desc")}
            </p>
          </div>
      ...
      <section className="p-6 sm:p-8 rounded-3xl bg-slate-900 text-white shadow-xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            <span className="text-xs font-bold text-indigo-400 uppercase tracking-wider block">{t("home.archBadge")}</span>
