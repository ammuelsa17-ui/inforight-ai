...
> *The citizen inspects the side-by-side evidence on their dashboard. If satisfied, they confirm and close the case; if the repair was incomplete, they can reopen the cycle with one click. A PDF with SHA-256 integrity record is generated for public record."*
